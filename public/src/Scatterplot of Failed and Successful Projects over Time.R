...
#Updated: 2/3/2019
#Creating a Scatterplot of Failed and Successful Projects by Year
...
#Scatterplot of Year and Number of Failed and Successful Projects
byYear <- ggplot(data = yearly17, aes(x = year, y = numberFailed)) + geom_line(show.legend = TRUE, aes(col = "Failed Projects")) + geom_point(aes(col = "Failed Projects"))
byYear2 <- byYear + geom_line(data = yearly17, aes(x = year, y = indicator, col = "Successful Projects"), show.legend = TRUE) + geom_point(data = yearly17, aes(x = year, y = indicator, col = "Successful Projects"))
byYear3 <- byYear2 + scale_x_continuous(name = "Year", breaks = c(2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018), labels = c(2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018)) + ggtitle("Number of Failed and Successful Projects by Year") + labs(col = "") + ylab("Number of Projects")
